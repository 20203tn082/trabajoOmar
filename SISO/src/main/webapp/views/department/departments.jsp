...
<div id="main">
  ...
  <div class="container">
    ...
    <form action="${context}/ServletDepartments" method="get">
      ...
      <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i> Agregar departamento</button>
    </form>
    <br>
<table class="table table-striped">
  ...
  <tbody>
  <c:forEach items="${ listDepartments }" var="department" varStatus="status">
    <tr>
      <td>${ status.count }</td>
      ...
      <td>
        <form action="${context}/ServletDepartments" method="POST" style="display: inline;">
          <input type="hidden" name="action" value="getDepartmentById">
        ...
        <button type="button" class="btn btn-outline-danger btn-sm" onclick="recibir('${ department.idDepartment }', '${department.nameDepartment}')" data-bs-toggle="modal" data-bs-target="#delete"><i class="fas fa-trash"></i> Eliminar</button>
      </td>
    </tr>
  </c:forEach>
  </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ¿Estas seguro de querer eliminar el departamento de <span id="name"></span>?
      </div>
